...
**Progreso:** 12 / 71 · **4.2.3 cerrado** ✅ · **4.2.1 casi cerrado** (falta 4.2.1-G y nota del párrafo del decay)
...
- [x] 🔴 Buscar y reemplazar **«HGT»** en todo el capítulo 4 → **GATv2**. Cuatro apariciones: 4.2.2, 4.2.4, 4.3.4 (×2)
- [x] 🔴 **4.3.2-E** · Quitar el párrafo de las macro en el nodo Estados Unidos. No se hizo: todos los países llevan las mismas 11 features
- [x] 🔴 **4.3.2-A** · Quitar la OPEP+ de 4.3.2 (ya la quitaste de 4.2.4)
- [x] 🔴 **4.3.2-D** · «producto interior bruto mundial» → **peso de comercio bilateral con EE. UU.**
...
- [X] ⚪ «Puntuacioón» → Puntuación
- [x] ⚪ «notícia» → noticia
- [x] ⚪ «cuando llega al 2005 **són** anuales» → son · y falta el sujeto (GDELT empaqueta…)
- [x] ⚪ «Latent **Drichlet** Allocation» → Dirichlet
- [x] ⚪ «el **grupoing**» → el agrupamiento
- [ ] ⚪ «complementar el **gruposy** descubrir» → los grupos y descubrir
- [ ] ⚪ «para ver **cual** es el umbral» → cuál
- [x] ⚪ «100000 a 300000» → 100.000 a 300.000
...
- [ ] ⚪ **4.2.1-G** · «Adicionalmente» → «Además» *(sigue «Adicionalmente» en el párrafo de Hawkes)*
...
- [x] 🔴 **4.2.2-B** · Declarar la **tercera relación** `market→country`. Es la que hace verdad el argumento de la interacción bidireccional
...
- [x] 🔴 **4.2.4-A** · Los ejemplos «militar / comercial / diplomático / legislativo» **no son posibles con QuadClass**. Reescribirlos en el eje cooperación-conflicto / verbal-material (afecta también a 4.3.2)
- [x] 🔴 **4.2.4-B** · Tercera aparición del HGT → GATv2
- [x] 🟡 **4.2.4-C** · Declarar que los pesos de comercio bilateral son estimaciones propias, no una fuente citada
- [x] ⚪ **4.2.4-D** · Maquetar la tabla de QuadClass: cabecera partida, «2.198.6 / 57» roto, falta la nota de redondeo y «Fuente: Elaboración propia»

### 4.2.5 Régimen de datos

- [x] 🟠 **A** · «en torno a las dos mil» → **2.751 grafos**
- [x] 🟠 **B** · «decena o cientos de miles de parámetros» → cifra real (contarla antes)
- [x] 🟠 **C** · «entre 32 y 128» → **64**
- [x] 🟠 **D** · «dos o tres capas» → **2**
- [x] 🟠 **E** · «dropout entre 30 % y 50 %» → **0,3** · weight decay **1e-4** · paciencia **15** sobre **validación interna** (15 % final del train)
- [x] 🟠 **F** · «entre tres y cinco semillas» → **3: (0, 1, 2)**
- [x] 🟡 **G** · Conectar el régimen de datos con la elección de QuadClass: una operación de atención por tipo de arista, ×5 tipos = ×5 parámetros
...
- [x] 🔴 **4.3.2-A** · OPEP+ *(ya en el bloque exprés)*
- [x] 🟠 **4.3.2-B** · «aproximadamente una veintena» y «no se cierran a nivel arquitectónico» → **20 cerrados**, con la lista
- [x] 🟠 **4.3.2-C** · Cuarta vez que la granularidad «se determinará» → QuadClass, remitiendo a 4.2.4
- [x] 🔴 **4.3.2-D** · PIB → comercio bilateral *(ya en el bloque exprés)*
- [x] 🔴 **4.3.2-E** · Macro en el nodo USA *(ya en el bloque exprés)*
- [x] 🔴 **4.3.2-F** · Declarar las **9 features** del nodo mercado y que **3 están inactivas** (DXY nunca se rellena; `USAR_MACRO = False`)
- [x] 🟠 **4.3.2-G** · «cuya base será el comercio bilateral, posiblemente complementada» → 1 feature, sin complementar
- [x] 🟡 **4.3.2-H** · Detallar las **7 features** de arista país-país (3 + one-hot QuadClass)
- [x] ⚪ **4.3.2-I** · «En cuanto a **artistas**» → aristas

### 4.3.3 Evolución temporal

- [x] 🟠 **4.3.3-A** · «se ajustarán durante la experimentación» → λ, multiplicadores y ventana
- [x] 🟠 **4.3.3-B** · La promesa del barrido de λ → según **P1**, retirar o pasar a §7.2
- [x] 🔴 **4.3.3-C** · «histórico de eventos acumulado» → **ventana de 60 días**

### 4.3.4 Modelo

- [x] 🟠 **4.3.4-A** · «HGT o HeteroGAT… se reserva como ajuste empírico» → GATv2 vía HeteroConv
- [x] 🟠 **4.3.4-B** · «dimensión moderada / dos o tres capas / cabezas a determinar» → **64 / 2 / 4 / dropout 0,3**
- [x] 🔴 **4.3.4-C** · «dropout y **normalización**» → **no hay ninguna capa de normalización**
- [x] 🟡 **4.3.4-D** · Añadir la **conexión residual** y la **cabeza MLP de 2 capas**

### 4.3.5 Cabeza de predicción

- [x] 🟠 **4.3.5-A** · «se determinará… contemplándose opciones» → **terciles**, recalculados por fold sobre su train
- [x] 🟠 **4.3.5-B** · «se contempla ponderar la pérdida» → no se ponderó (`usar_pesos_clase = False`)
- [x] 🔴 **4.3.5-C** · «el procedimiento exacto de corte temporal se afinará» → ver **4.1-C**

### 4.3.6 Entrenamiento y evaluación

- [x] 🟠 **4.3.6-A** · «se fijarán en función del periodo» → **10 folds**, expansiva, en muestras, 250 sesiones de validación
- [x] 🟡 **4.3.6-B** · Declarar el **embargo 0**
- [x] 🟠 **4.3.6-C** · «varias semillas» → 3
- [x] 🟠 **4.3.6-D** · «se contempla evaluar desde una perspectiva financiera» → se hizo, está en §5.4
- [x] 🔴 **4.3.6-E** · La **LSTM financiera** no existe
- [x] 🔴 **4.3.6-F** · El **baseline geopolítico sin grafo** no existe

---

## 5 · Incoherencias entre capítulos

- [x] 🔴 **X-1** · Alinear §4.3.6 con lo que ya admite el capítulo 6: enumerar los **tres** baselines construidos y dejar los otros dos como línea futura. Revisar también el **objetivo específico 4 del §3.2**, que exige superar un modelo sin información geopolítica
- [x] 🟠 **X-2** · «Crecimiento exponencial de fuentes» en §2.1.3 y §5 contradice los datos: los eventos por año **caen** desde 2016. Considerar el gráfico de eventos por año en §4.1
...
- [x] Contar los parámetros entrenables: `sum(p.numel() for p in modelo.parameters() if p.requires_grad)` → **57.603** (proj_country 768 · proj_market 640 · capas 51.840 · cabeza 4.355)
